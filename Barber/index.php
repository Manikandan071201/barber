        ...
        <div class="features">
            ...
            <div class="features-desc">
                ...
                <div class="features-text">
                    <p>Donec eget ultricies sapi. Sed porttitor,maurisater lob faclisis,
...
<section id="testimonial">
    ...
    <div class="testimonial-row">
        <div class="testimonial-col">
            ...
            <p>Donec eget ultricies sapi.sed porttitor, maurisater 
            lob faclisis, elit sapie eleifend ligula. Donec 
            eget ultricies sapi.Donec eget ultricies sapi.sed 
            porttitor,maurisater lob faclisis, elit sapie 
            eleifend ligula. Donec eget ultricies sapi.</p>
        </div>
        <div class="testimonial-col">
        <div class="user">
           ...
           <p>Donec eget ultricies sapi.sed porttitor, maurisater 
            lob faclisis, elit sapie eleifend ligula. Donec 
            eget ultricies sapi.Donec eget ultricies sapi.</p>
        </div>
        <div class="testimonial-col">
        <div class="user">
...
<section id ="footer">
    ...
    <div class="social-links">
        ...
        <p>Copyrights Barber shop & Hair Studio</p>
    </div>
</section>
<script>
